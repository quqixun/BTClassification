...
def rescale(data, shape=[112, 96, 112]):
...
in_dir = os.path.join(parent_dir, "data", "trimmed_110-110-110_full_processed")
out_dir = os.path.join(parent_dir, "data", "full_processed")
